...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            Thread.Sleep(500);
            GetTemp(serialPort, writer, 16);
            Thread.Sleep(500);
            GetTemp(serialPort, writer, 24);
            Thread.Sleep(500);
            GetTemp(serialPort, writer, 32);
            Thread.Sleep(500);
            GetTemp(serialPort, writer, 40);
            Thread.Sleep(500);
            GetTemp(serialPort, writer, 48);
            Thread.Sleep(500);
            GetTemp(serialPort, writer, 56);
            Thread.Sleep(500);
            GetTemp(serialPort, writer, 64);
            Thread.Sleep(500);
            GetTemp(serialPort, writer, 72);
            Thread.Sleep(500);
            GetTemp(serialPort, writer, 80);
            Thread.Sleep(500);
